...
describe('TransaksiPenjualan', () => {
    ...
    it('Running', () => {
        cy.visit('/dashboard');
    sidemenu.changeMenuTransaksiPenjualan("false");
        cy.wait(400);
        sidemenu.changeMenuLihatPenjualan("true");
        cy.wait(400);
        sidemenu.changeMenuBatalPenjualan("true");
        cy.wait(400);
        sidemenu.changeMenuLihatTitipan("true");  
    });
})
